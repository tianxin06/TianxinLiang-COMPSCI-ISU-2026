...
public class Main{
    public static void main(String[] args) {
        ...
        while(running){
            ...
            switch(choice){
                ...
                case 2:
                    //rating average
                    if(title.size() == 0){
                        System.out.println("No songs please go to main menu to add songs");
                ...
                case 3:
                    //finding the max/min rated songs
                    if(title.size() == 0){
                        System.out.println("No songs please go to main menu to add songs");
                        System.out.println("returning to main menu...");
                    }
        ...
        sc.close();
        //Hello, Ms. Rastegar, you're such a nice and understanding teacher, it's been very fun to have another class with you this semster again!!:D
        //have a nice summer break, and best of luck for future pursuits!:D
    }
}